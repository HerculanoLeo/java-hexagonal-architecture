...
| Artefato                        | Path                                                                                          |
|---------------------------------|-----------------------------------------------------------------------------------------------|
| Application                     | `backend/api-cadastros/src/main/java/com/herculanoleo/starter/Application.java`               |
| Config                          | `backend/api-cadastros/src/main/java/com/herculanoleo/starter/cadastros/infra/configuration/` |
...
| Modulith test                   | `backend/api-cadastros/src/test/java/com/herculanoleo/starter/ApplicationTest.java`           |
...
- **Datasource + Liquibase:** PostgreSQL **18+** (`spring-boot-starter-liquibase`); master agrega changelogs dos
  módulos; schemas de domínio `plataformadmin`, `notification`, `location`, `security`; `event_publication` em
...
- Imagens: `backend/api-cadastros/Dockerfile` (JAR pré-buildado), `frontend/Dockerfile` (runtime; `pnpm build` na
