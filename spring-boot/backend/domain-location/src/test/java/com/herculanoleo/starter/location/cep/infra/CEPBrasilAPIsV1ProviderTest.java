...
class CEPBrasilAPIsV1ProviderTest {

    @Mock
    private CEPCacheService cacheService;

    @InjectMocks
    private CEPBrasilAPIsV1Provider provider;
    ...
    void findByCep_shouldDelegateToCacheServiceWithCorrectUrl() {
        ...
        when(cacheService.doRequest(CEPBrasilAPIsV1Provider.URL, cep)).thenReturn(expectedResult);
        ...
        verify(cacheService, times(1)).doRequest(CEPBrasilAPIsV1Provider.URL, cep);
