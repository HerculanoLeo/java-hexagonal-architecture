...
import com.herculanoleo.starter.identity.usuario.domain.Usuario;
...
import com.herculanoleo.starter.plataformadmin.usuarios.domain.UsuarioSistemaGrupo;
...
class UsuarioSistemaServiceImplTest {
    ...
    void resetPassword_success() {
        ...
        UsuarioSistema systemUser = new UsuarioSistema(id, "user-id", "Name", "email", Status.ATIVO, 1, offsetDateTime, offsetDateTime);
        when(repository.findById(id)).thenReturn(Optional.of(systemUser));
